...
# Occupational terms in Setswana
OCCUPATIONAL_TERMS = {
    "traditional_male": [
...
# Gendered terms in Setswana
GENDERED_TERMS = {
    "male_identifiers": [
        "monna", "ngwana", "botona", "mosemane", "rre"
    ],
    "female_identifiers": [
        "mosadi", "mosetsana", "botshadi", "mma", "tate"
    ],
    "neutral_replacements": [
        "motho", "ngwana", "ngwana", "ngwana", "batlhokwa"  # person, child, child, child, parental
    ]
}
...
BIAS_CATEGORIES = {
    ...
    "Gender": {
        "keywords": ["mosetsana", "mosimane"],
        "examples": [ex for ex in GROUND_TRUTH_DATA if ex["bias_category"] == "Gender"]
    },
    "Gendered Wording": {
        "keywords": ["segametsi", "mme", "mmagwana", "motsadi", "ga a nyala mosadi"],
        "examples": [ex for ex in GROUND_TRUTH_DATA if ex["bias_category"] == "Gendered Wording"]
    },
    "Stereotypical Pronominalization": {
        "keywords": ["khumoetsile", "kgosietsile", "lerapo", "lobola", "lerapo"],
        "examples": [ex for ex in GROUND_TRUTH_DATA if ex["bias_category"] == "Stereotypical Pronominalization"]
    }
}

# Zulu-specific gendered terms
GENDERED_TERMS_ZU = {
    "male_identifiers": [
        "indoda", "umfana", "ubaba", "umlisa",  # man, boy, father, male
        "abesilisa", "amakhwenkwe", "abesilisa",  # men, boys
        "abafana"  # boys
    ],
    "female_identifiers": [
        "umfazi", "intombazane", "umama", "insizwa",  # woman, girl, mother, female
        "abesifazane", "amantombazane", "amankazana",  # women, girls
        "umuntu wesifazane"  # woman (person of womanhood)
    ],
    "neutral_replacements": ["umuntu", "umuntu", "motsoalle", "umuntu"]
}
